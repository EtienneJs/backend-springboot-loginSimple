package com.etienne.backend.userapp.backenduserapp.controller;
...
import com.etienne.backend.userapp.backenduserapp.services.UserService;
...
public class UserController {
    ...
    public ResponseEntity<?> remove(@PathVariable Long id){
        Optional<UserDto> exist = service.findById(id);
        if(exist.isPresent()){
            service.remove(id);
